...
public:
	...
	Vector3(const Vector2 &v, float e2) {e[0]=v.e[0]; e[1]=v.e[1]; e[2]=e2;}
	Vector3(float e0) {e[0]=e[1]=e[2]=e0;}
    inline float x() const { return e[0]; }
    inline float y() const { return e[1]; }
    inline float z() const { return e[2]; }
    inline void setX(const float a) { e[0] = a; }
    inline void setY(const float a) { e[1] = a; }
    inline void setZ(const float a) { e[2] = a; }
	inline void set(const float enew) {e[0]=enew; e[1]=enew; e[2]=enew; }
	inline void set(const float *enew) {e[0]=enew[0]; e[1]=enew[1]; e[2]=enew[2]; }
	inline void set(const float e0, const float e1, const float e2) {e[0]=e0; e[1]=e1; e[2]=e2; }
    ...
    void makeUnitVector();
	Vector3 normalize() {makeUnitVector(); return *this;}
...
#define CONVERT_V3_to_V2(s, d) {d.e[0]=s.e[0]; d.e[1]=s.e[1];}
#define CONVERT_V2_to_V3(s, d) {d.e[0]=s.e[0]; d.e[1]=s.e[1];}
// sungeui end -----------------
...
inline Vector3 operator+(const float v1, const Vector3 &v2) {
	return Vector3( v1 + v2.e[0], v1 + v2.e[1], v1 + v2.e[2]);
}
inline Vector3 operator+(const Vector3 &v1, const float v2) {
	return Vector3( v1.e[0] + v2, v1.e[1] + v2, v1.e[2] + v2);
}
...
inline Vector3 triNormal(const Vector3 &v0, const Vector3 &v1, const Vector3 &v2) {
...
inline bool isNaN(const Vector3& v) {
	return (_isnan(v.e[0]) || _isnan(v.e[1]) || _isnan(v.e[2]));
}

inline Vector3 toLH(const Vector3& v) {
	Vector3 out(v);
	out.e[2] = -v.e[2];
	return out;
}
inline Vector3 abs(const Vector3& v) {
	Vector3 out(v);
	out.e[0] = v.e[0] > 0.0f ? v.e[0] : -v.e[0];
	out.e[1] = v.e[1] > 0.0f ? v.e[1] : -v.e[1];
	out.e[2] = v.e[2] > 0.0f ? v.e[2] : -v.e[2];
	return out;
}

inline Vector3 clamp(const Vector3& v, float low, float high) {
	Vector3 out;
