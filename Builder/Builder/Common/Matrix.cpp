...
void Matrix::fromAngleAxis(Vector3 angle, float rot) {
	...
	Real fX2 = angle[0]*angle[0];
	Real fY2 = angle[1]*angle[1];
	Real fZ2 = angle[2]*angle[2];
	Real fXYM = angle[0]*angle[1]*fOneMinusCos;
	Real fXZM = angle[0]*angle[2]*fOneMinusCos;
	Real fYZM = angle[1]*angle[2]*fOneMinusCos;
	Real fXSin = angle[0]*fSin;
	Real fYSin = angle[1]*fSin;
	Real fZSin = angle[2]*fSin;
