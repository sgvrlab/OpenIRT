...
I32 IntegerCompressorNew::DecompressLast(I32 pred, I32 posNeg)
{
  I32 read = readCorrector(ad_last, amSmallLast, amHighLast);
...
// sungeui start --------------------------------------------------------
int IntegerCompressorNew::GetLastCompressedInt (void)
{
  return last;
}
int IntegerCompressorNew::GetLastDecompressedInt (void)
{
  return last;
}
#if 1
...
void IntegerCompressorNew::SetupCompressor(REType* re)
{
  ae_none = re;
  ae_last = re;
  ae_across = re;
...
template <typename REType>
void IntegerCompressorNew::SetupDecompressor(REType* rd)
{
  ad_none = rd;
  ad_last = rd;
  ad_across = rd;
