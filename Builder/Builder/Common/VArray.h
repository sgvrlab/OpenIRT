...
class VArray 
{
  ...
  public:
    ...
    inline void RemoveLastElement(void);
    // Make Capacity == Count
    inline void Pack();
    ...
    //template <class Type> friend istream& TEMPL_FRIEND(Read)(istream& in, VArray<Type>& arr);
     //template <class Type> friend ostream& TEMPL_FRIEND(Write)(ostream& out, const VArray<Type>& arr);
...
template <class Type>
inline void VArray<Type>::RemoveLastElement(void)
{
  count--;
}   
//-----------------------------------------------------------------------------
