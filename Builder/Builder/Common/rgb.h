...
public:
	...
	void clamp() {
		...
		data[0] = (data[0] > 1.0f)?1.0f:data[0];
		data[1] = (data[1] > 1.0f)?1.0f:data[1];
		data[2] = (data[2] > 1.0f)?1.0f:data[2];		

		data[0] = (data[0] < 0.0f)?0.0f:data[0];
		data[1] = (data[1] < 0.0f)?0.0f:data[1];
		data[2] = (data[2] < 0.0f)?0.0f:data[2];		
	}
