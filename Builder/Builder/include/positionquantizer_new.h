...
public:
  ...
  // DeQuantize:
  inline void DeQuantize(const unsigned short* pQuantPosition, F32* pValue, int pos);
...
//-----------------------------------------------------------------------------
inline void PositionQuantizerNew::DeQuantize(const unsigned short* pQuantPosition, F32* pValue, int pos)
{
  *pValue = (F32)(m_dDeQuantizeMultiplier*pQuantPosition[pos] + (F64)m_afMin[pos]);// is that casting a good idea? jack says ... yes.
}
//-----------------------------------------------------------------------------
